...
import com.firedevz.sistemadegestaofinanceira.activity.ActivityAdicionarProdutos;
...
public class ActivityProdutos extends AppCompatActivity {
    ...
    private Button btnPro,btnPesquisarPro,btnAdicionarPro,btnEditarPro;
    ...
    private void inicializaComponentes() {
        ...
        btnPesquisarPro = (Button) findViewById(R.id.btnPesquisarPro);
        btnAdicionarPro = (Button) findViewById(R.id.btnAdicionarPro);
        btnEditarPro = (Button) findViewById(R.id.btnEditarPro);
    }
    ...
    private void eventoClikes() {
        btnPro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), activityListaProdutos.class);
                startActivity(i);
            }
        });
//        btnPesquisarPro.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//            }
//        });
        btnAdicionarPro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
